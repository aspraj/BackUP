...
public class ConsumerDemo {
	...
	public static void main(String[] args) {
		...
		Consumer<Integer> consumer = (Integer x)->System.out.println(x);
			//(Integer x)->System.out.println(x) just taking the argument and printing the value
		...
		System.out.println("**********************************");
		// We can print exact same value as consumer with the help of for each which is written downside 
