package com.springmvcjpaapp.controller;
...
import com.springmvcjpaapp.service.EmployeeService;
...
//
	// Delete
	@GetMapping("/deleteemployeeById/{empId}")
	public ModelAndView deleteEmployeeById(@PathVariable Integer empId) {
...
//	public ModelAndView getEmployeeToUpdate(@ModelAttribute Employee employee) {
